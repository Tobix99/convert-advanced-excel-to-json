...
const excelToJson = (function() {
    ...
    function getSheetCellValue(sheetCell) {
        ...
        let returnValue ={};
        if(sheetCell.s!==undefined){returnValue.style=sheetCell.s}
        returnValue.data = (sheetCell.t === 'n' || sheetCell.t === 'd') ? sheetCell.v : (sheetCell.w && sheetCell.w.trim && sheetCell.w.trim()) || sheetCell.w;
        return returnValue;
    };
